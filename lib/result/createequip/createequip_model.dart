...
class CreateequipModel extends FlutterFlowModel {
  ...
  // State field(s) for classinfo widget.
  String? classinfoValue;
  FormFieldController<String>? classinfoValueController;
  // State field(s) for Characteristicvalue widget.
  TextEditingController? characteristicvalueController;
  String? Function(BuildContext, String?)?
  ...
  void dispose() {
    ...
    characteristicvalueController?.dispose();
  }
